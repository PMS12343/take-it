...
MIDDLEWARE = [
    ...
    'pharmacy_app.middleware.RoleMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pharmacy_app.utils.notifications_processor',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('PGDATABASE', 'pharmacy_db'),
...
SALES_CLERK_ROLE = 'Sales Clerk' 
MANAGER_ROLE = 'Manager'

ROLES = [ADMIN_ROLE, PHARMACIST_ROLE, SALES_CLERK_ROLE, MANAGER_ROLE]

# Drug expiry notification threshold (in days)
DRUG_EXPIRY_THRESHOLD = 60  # 2 months
